...
const CACHE_NAME = 'learnhub-static-v253.0.0';
const RUNTIME_CACHE = 'learnhub-runtime-v253.0.0';
...
const STATIC_ASSETS = [
  ...
  './js/data/api.js',
  './js/services/appSecurityGuard.js',
  './js/services/auth.js',
...
self.addEventListener('install', (event) => {
  ...
  event.waitUntil(
    caches.open(CACHE_NAME).then((cache) => {
      console.log('[ServiceWorker] Pre-caching App Shell v253.0.0');
