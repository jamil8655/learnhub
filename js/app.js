        ...
        <div class="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 rounded-3xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
          ...
          <div class="p-8 sm:p-10 flex flex-col justify-between space-y-6">
            <div>
              ...
              <!-- Social Auth Simulation & Official Google GIS -->
              <div class="pt-4 space-y-3">
                ...
                <div id="google-gis-btn-wrapper" class="w-full flex justify-center py-1"></div>

                <div class="grid grid-cols-2 gap-2 pt-1">
                  <button type="button" onclick="window.App.socialLogin('google')" class="btn-secondary py-2.5 text-xs rounded-xl flex items-center justify-center gap-2 hover:border-indigo-500 transition">
                    ...
                    <span class="font-bold">Google Sign-In</span>
                  </button>
                  <button type="button" onclick="window.App.socialLogin('github')" class="btn-secondary py-2.5 text-xs rounded-xl flex items-center justify-center gap-2 hover:border-indigo-500 transition">
