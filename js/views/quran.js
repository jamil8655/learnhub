          ...
          ${editions.map(e => `
            <div class="p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm hover:border-amber-400/50 hover:shadow-xl transition flex flex-col justify-between space-y-4">
              ...
              <div class="pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between gap-2">
                ...
                <button onclick="window.Router.navigate('/mushaf/${e.id}')" class="py-2 px-3 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-xs flex items-center gap-1 transition shadow">
                  <i data-lucide="book-open" class="w-3.5 h-3.5"></i>
                  <span>مصحف ریڈر کھولیں</span>
                </button>
              </div>
            </div>
          `).join('')}
        ...
        <div class="p-6 sm:p-8 rounded-3xl bg-gradient-to-r from-emerald-950 via-slate-900 to-teal-950 border-2 border-emerald-500/40 text-white flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl">
          <div class="space-y-2">
            ...
            <p class="text-xs text-emerald-100/80 leading-relaxed max-w-xl">
              اہل سنت و جماعت کی 8 مستند اور عظیم الشان تفاسیر (ابن کثیر، احسن البیان، السعدی، طبری، قرطبی، معارف القرآن، جلالین، فتح القدیر)۔ تمام جلدوں کا ان-ایپ مطالعہ اور موبائل سے پی ڈی ایف اپلوڈ۔
            </p>
          </div>
            ...
            <div class="p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm hover:border-emerald-500/50 hover:shadow-xl transition flex flex-col justify-between space-y-4">
              <div class="space-y-3">
                ...
                <div class="flex items-center gap-2 pt-1">
                  <span class="text-xs text-slate-500 font-bold">کل جلدیں:</span>
                  <span class="badge bg-slate-100 dark:bg-slate-800 font-mono font-bold text-slate-700 dark:text-slate-300 text-xs">${(t.volumesList || []).length || 1}</span>
                </div>
              </div>
              <div class="pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between gap-2 flex-wrap">
                ...
                <a href="${t.downloadUrl}" target="_blank" class="py-2.5 px-3 rounded-2xl bg-slate-100 dark:bg-slate-800 hover:bg-emerald-600 hover:text-white text-slate-700 dark:text-slate-300 font-bold text-xs flex items-center gap-1.5 transition" title="مکمل پی ڈی ایف">
                  <i data-lucide="download" class="w-3.5 h-3.5"></i>
                </a>
              </div>
            </div>
